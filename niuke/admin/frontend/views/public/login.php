...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<?= Html::beginForm($action='index.php?r=public/check_login',$method='post'); ?>
	<!-- <form class="login-form" action="index.php?r=public/check_login" method="post"> -->
		<h3 class="form-title">牛客后台管理</h3>
