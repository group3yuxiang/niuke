...
<style type="text/css">
*{ padding: 0; margin: 0; }
body{ background: #E9F9F9; font-family: '微软雅黑'; color: #333; font-size: 16px; }
.system-message{ width:500px;height:100px; margin:auto;border:6px solid green;text-align:center; position:relative;top:200px;}
