						...
						<div class="portlet-body">
							...
							<tr class="odd gradeX">
								...
								<td>
									...
									<a href="index.php?r=type/del&id=<?php echo $v['_id'] ?>"><button class="btn green btn-xs" type="button">删除</button></a>
									
									<a href="index.php?r=type/upd&id=<?php echo $v['_id'] ?>"><button class="btn blue btn-xs" type="button">修改</button></a>
								</td>
							</tr>
							<?php } ?>
							</tbody>
							</table>
							<span><?php  echo LinkPager::widget(['pagination' => $pagination]); ?></span>
						</div>
					</div>
