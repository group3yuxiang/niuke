		...
		<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="portlet box purple">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<?= Html::beginForm($action='index.php?r=type/addact',$method='post',array('class'=>"form-horizontal form-bordered")); ?>
								<div class="form-body">
									<div class="form-group">
										<label class="control-label col-md-3">名称</label>
										<div class="col-md-4">
											<input type="text" class="form-control" maxlength="25" name="name" id="maxlength_defaultconfig">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<select class="form-control input-medium select2me" data-placeholder="Select..." name='pid'>
												...
												<option value="<?php echo $v['_id'] ?>"> <?php echo $v['name'] ?></option>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control" maxlength="25" name="level" id="maxlength_defaultconfig">
											<span class="help-block">
								...
								<div class="btn-group" data-toggle="buttons">
									...
									<input type="radio" class="toggle" name='display' value='1'> Single </label>
									<label class="btn blue">
									<input type="radio" class="toggle" name='display' value='all'> All </label>
